...
rn <- resultsNames(dds)
message("ℹ️ resultsNames(dds): ", paste(rn, collapse = ", "))
...
```{r}
# ============================================================
# 05c – Summarizing results from the Wald test (HBC)
# Ziel:
...
# Tipp: !is.na(padj) explizit, damit NAs nicht „durchrutschen“
# ------------------------------------------------------------
...
# ------------------------------------------------------------
# Schritt 6 (praktisch): Genlisten erzeugen (für Heatmaps/Enrichment etc.)
# ------------------------------------------------------------
...
# Optional: Export (falls gewünscht)
