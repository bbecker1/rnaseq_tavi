...
## GO ORA (Helper-Funktionen)

Helper-Funktionen für Gene Ontology Over-Representation Analysis. Definiert Funktionen für Genlisten-Erstellung, enrichGO-Aufrufe und Ergebnis-Speicherung.

```{r}
#| label: go-ora-helpers
#| echo: false
#| warning: false
...
run_go_ora_set_lfc <- function(res_obj,
  ...
  for (ont in ontologies) {
    for (dir in directions) {
      ...
      # CACHING: Prüfen ob RDS existiert
...
Erstellt Visualisierungen (Dotplots, Emapplots, Cnetplots) aus gecachten ORA-Ergebnissen. Lädt RDS-Dateien und erzeugt publikationsreife Plots in `../../res/functional/*/plots/`.
...
Erstellt eine kombinierte Figure mit GO-Dotplots, KEGG-Dotplots und Pathway-Heatmap für V1 vs A und V2 vs V1. Einheitliche Farbskalen und optimiertes Layout für Publikationen.
